...
%      inv(tt) = (1-lambda(tt))/b(tt)*sqrt((nu(tt)-2)/nu(tt))*tinv(u(tt)/(1-lambda(tt)),nu(tt))-a(tt)/b(tt);
%   else
%      inv(tt) = (1+lambda(tt))/b(tt)*sqrt((nu(tt)-2)/nu(tt))*tinv(0.5+1/(1+lambda(tt))*(u(tt)-(1-lambda(tt))/2),nu(tt))-a(tt)/b(tt);
%   end
%end
