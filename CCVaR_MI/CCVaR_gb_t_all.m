function varargout=CCVaR_gb_t_all(r,p,par_gb,par_arma1,par_arma2,sig1,sig2,N,s,beta)
%Estimate copula based CVaR with Gumbel-Barnett copula and margins modeled by
...
for i=1:ni
  ...
  nu1=par_arma1{i}.Distribution;
	...
	CCVaR_out(i) = CCVaR_gb_t(beta, p, [mu1, sigma1,nu1.DoF], [mu2, sigma2, nu2.DoF], w, N);
	i
end
