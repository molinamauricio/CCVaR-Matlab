function varargout=CCVaR_gum_t_all(r,p,par_gum,par_arma1,par_arma2,sig1,sig2,N,s,beta)
%Estimate copula based CVaR with Gumbel copula and margins modeled by
%AR(1)-GARCH(1,1) with student-t distribution.
...
for i=1:ni
	...
	CCVaR_out(i) = CCVaR_gum_t(beta, p, [mu1, sigma1,nu1.DoF], [mu2, sigma2, nu2.DoF], w, N);
	i
end
