function varargout=CCVaR_gb_s_all(r,p,par_gb,par_arma1,par_arma2,sig1,sig2,N,s,beta)
%Estimate copula based CVaR with Gumbel-Bernett copula and margins modeled by
...
for i=1:ni
  ...
  parameters(1,1)=par_arma1{i}(1);
	...
	CCVaR_out(i) = CCVaR_gb_s(beta, p, [mu1, sigma1,nu1, lambda1], [mu2, sigma2, nu2, lambda2], w, N);
	i
end
